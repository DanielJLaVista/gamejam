...
namespace MonoGameLibrary.Graphics {
    public class TextureAtlas {
        ...
        /// </summary>
        /// <param name="texture"> The soruce texture represented by the texture atlas.</param>
        ...
        public void PrintAtlas() {
            foreach (KeyValuePair<string, TextureRegion> kvp in _regions) {
                //textBox3.Text += ("Key = {0}, Value = {1}", kvp.Key, kvp.Value);
                Console.WriteLine ("Key = {0}, Value = {1}", kvp.Key, kvp.Value.SourceRectangle);
            }
        }
        /// <summary>
